...
1. Install the required SDK packages using one of these two methods:
   ...
   1) Using Android Studio, open `Tools > Android > SDK Manager`, in the SDK Tools tab,
      install "Android SDK Build-Tools", CMake and NDK.

   2) From the command line, run this script for a quick setup without Android Studio.
